...
- Plan workflow skills that own commits must use their required-gate commit helpers, which delegate to `ax commit --require-review-gate`; raw `git commit` remains Rene's manual terminal escape hatch.

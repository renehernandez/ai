/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workspace/wrangler.jsonc workspace/worker-configuration.d.ts` (hash: 4887f2ba35bdeb4d6f7d32fc7a30184a)
// Runtime types generated with workerd@1.20260701.1 2026-07-01 
interface __BaseEnv_Env {
	AX_WORKSPACE_ENVIRONMENT: "production";
	AX_WORKSPACE_KEY: "rene";
	WORKSPACES: DurableObjectNamespace<import("./src/index").AgentWorkspace>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AgentWorkspace";
	}

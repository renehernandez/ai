...
commands, installed runtime roots, or local profile refresh mechanics. The
concrete commands for recording and recovering private artifacts belong in
`skills/ax-cli` and repo-local runtime rules.

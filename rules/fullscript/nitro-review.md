...
## Automatic Nitro Review Requests

- After creating a GitLab MR, request a `nitro` review with `glab mr note <MR_IID> -m "/request_review @nitro"` unless the user explicitly opted out or the project does not use Nitro.

...
- mandatory `feature-delivery` and `plan-to-pr` gates
...
- RED: current feature-delivery and plan-to-pr docs allowed completion without any mandatory adversarial scrutiny gate.

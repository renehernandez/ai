...
- `plan-to-pr` or `plan-to-review` must wait for Codex feedback on the latest PR head.
...
- RED: prior `plan-to-pr` evidence recorded a PR where `@codex review` was requested but feedback arrived after completion.

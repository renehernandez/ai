...
Validate `planning_review`, derive one `plan_delivery_handoff`, pass the single approved unit to
...
In `ship_then_continue`, Plan Unit Sequencer advances only from target-branch

...
request review, resolve discussions, publish, or merge. Missing `glab` access
or authentication returns a concrete hosted-verification gap, never a guessed
pass.
...
- Review resolves a GitLab MR and needs its complete hosted artifact state.
